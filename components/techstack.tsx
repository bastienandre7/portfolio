        ...
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-16 items-start">
          <div className="lg:sticky lg:top-32 space-y-4">
            ...
            >
              ...
              <span className="italic text-[#2F6B4F] font-normal block">
                pour durer.
              </span>
            </h2>
          </div>

          <div className="divide-y divide-[#E4E6E0]/60 border-t border-b border-[#E4E6E0]/60 w-full">
            {stack.map(({ icon: Icon, title, description }) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[#EAF1EC] flex items-center justify-center shrink-0 border border-[#2F6B4F]/5 transition-colors group-hover:bg-[#2F6B4F] group-hover:text-white">
                  <Icon
                    size={18}
                ...
                <div className="space-y-1">
                  <h3 className="text-lg font-medium text-[#14171C] group-hover:text-[#2F6B4F] transition-colors duration-200">
                    {title}
                  </h3>
                  <p className="text-sm text-[#5B6168] leading-relaxed font-light max-w-xl">
                    {description}
                  </p>
                </div>

                <div className="hidden sm:block ml-auto opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-[#2F6B4F] text-sm self-center">
                  →
                </div>
              </div>
            ))}
